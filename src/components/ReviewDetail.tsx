...
export default function ReviewDetail({ review, game, onBack, similarGames, onGameSelect, onAdminAccess, onNavigate }: ReviewDetailProps) {
  ...
  return (
    ...
    >
      {/* Top Navigation */}
      <header className="sticky top-0 z-[100] bg-gamex-black/80 backdrop-blur-md border-b border-gamex-border h-[68px] px-6 md:px-12 flex items-center justify-between">
        <div className="flex items-center gap-10">
          <span className="font-display text-2xl tracking-tighter text-brand-red cursor-pointer" onClick={onBack}>GAMEX</span>
          <nav className="hidden lg:flex items-center gap-6 text-[11px] font-bold uppercase tracking-widest text-gamex-text-secondary">
            <button onClick={() => onNavigate?.('home')} className="hover:text-white transition-colors">Home</button>
            <button onClick={() => onNavigate?.('genres')} className="hover:text-white transition-colors">Genres</button>
      ...
      <div className="max-w-[100%] px-6 md:px-12 py-16 grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            <nav className="flex flex-col gap-4">
              {chapters.map((chapter) => (
                <button 
                  ...
                  className={`text-left text-sm font-semibold transition-colors duration-300 ${
                    activeChapter === chapter ? 'text-brand-red' : 'text-gamex-text-secondary hover:text-white'
                  }`}
                >
                  {chapter}
                </button>
        ...
        <div className="lg:col-span-9 space-y-16">
          <div className="space-y-12">
            <h2 className="text-4xl text-white font-display uppercase tracking-widest">The Golden Order is Broken</h2>
            <div className="font-sans text-base leading-relaxed text-gamex-text-secondary space-y-6 max-w-4xl">
              <p>
                From the moment you step out into the sprawling vistas of Limgrave, it's clear that FromSoftware has achieved something monumental. Elden Ring takes the tightly wound, meticulously crafted level design of its predecessors and scatters it across a breathtakingly massive open world without losing an ounce of its signature tension or mystery.
              </p>
              <p>
                The narrative, co-authored with George R.R. Martin, provides a richer, slightly more accessible lore foundation, though the storytelling remains fundamentally opaque and relies heavily on environmental observation and item descriptions. You are a Tarnished, guided by grace to brandish the power of the Elden Ring and become an Elden Lord. But the path is fraught with demigods, madness, and beautiful decay.
              </p>
            </div>
            ...
            <div className="space-y-6 !mt-24">
              <h3 className="text-[11px] font-bold uppercase tracking-[0.3em] text-gamex-neutral border-b border-gamex-border pb-4">Technical Breakdown</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="p-8 bg-gamex-surface border border-gamex-border rounded-sm space-y-8 flex flex-col items-center">
                  ...
                  <div className="relative w-32 h-32 flex items-center justify-center">
                    <svg className="w-full h-full -rotate-90">
                      ...
                      <circle
                        ...
                        strokeDashoffset={2 * Math.PI * 58 * (1 - 0.98)}
                        strokeLinecap="round"
                      />
                    </svg>
                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                      <span className="text-3xl font-display text-white">9.8</span>
                    </div>
                  </div>
                  <div className="w-full space-y-2">
                    ...
                    <div className="flex justify-between text-[9px] uppercase tracking-wider font-bold">
                      ...
                      <span className="text-brand-red">9.5</span>
                    </div>
                    <div className="flex justify-between text-[9px] uppercase tracking-wider font-bold">
                  ...
                  <div className="space-y-6 pt-4">
                    <div className="space-y-2">
                      <div className="flex justify-between text-[9px] uppercase tracking-wider font-bold">
                        ...
                        <span className="text-white/60">10/10</span>
                      </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-[9px] uppercase tracking-wider font-bold">
                        ...
                        <span className="text-white/60">9/10</span>
                      </div>
                      <div className="h-1.5 bg-white/5 rounded-full overflow-hidden">
                ...
                <div className="p-8 bg-gamex-surface border border-gamex-border rounded-sm space-y-8 flex flex-col">
                  ...
                  <div className="flex-1 flex items-end gap-1.5 h-32 pt-4">
                    {[70, 85, 65, 95, 90, 88].map((h, i) => (
                      <div 
                        key={i} 
                        className="flex-1 bg-brand-red/30 border-t-2 border-brand-red rounded-t-[1px]" 
                        style={{ height: `${h}%` }}
                      />
                    ))}
                  </div>
                  <div className="text-[9px] text-center text-gamex-neutral font-medium italic">
                    Frame Rate Stability: Solid 60 FPS
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 !mt-16">
              <div className="p-8 bg-[#151515] border border-white/5 rounded-sm space-y-6 relative overflow-hidden group">
                ...
                <div className="flex items-center gap-3 text-[#46D369]">
                   ...
                   <h4 className="text-[11px] tracking-[0.2em] uppercase font-display">The Highs</h4>
                </div>
              ...
              <div className="p-8 bg-[#151515] border border-white/5 rounded-sm space-y-6 relative overflow-hidden group">
                ...
                <div className="flex items-center gap-3 text-brand-red">
                   ...
                   <h4 className="text-[11px] tracking-[0.2em] uppercase font-display">The Lows</h4>
                </div>
                <ul className="space-y-4">
                  {lows.map((low, i) => (
                    <li key={i} className="flex gap-4 text-xs text-gamex-text-secondary leading-relaxed">
            ...
            <div className="!mt-16 bg-[#181818] border border-white/5 rounded-sm p-10 md:p-14 space-y-10 relative overflow-hidden">
               <h3 className="text-[11px] font-bold uppercase tracking-[0.4em] text-gamex-neutral">The Verdict</h3>
              ...
              {similarGames.slice(0, 5).map(({ game: g }) => (
                ...
                >
                  <div className="aspect-[2/3] overflow-hidden rounded-sm relative">
                    <img src={g.coverImage} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" alt={g.title} />
